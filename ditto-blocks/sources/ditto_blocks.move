module satay_blocks::ditto_blocks {
    ...
    ): (Coin<AptosCoin>, Coin<Y>, Coin<Z>, Coin<StakedAptos>) {
        let (
            apt_opt,
            y_opt,
            z_opt,
            tapt_coins
        ) = aggregator::swap_direct<AptosCoin, Y, Z, StakedAptos, u8, E2, E3>(
            num_steps,
            first_dex_type,
            first_pool_type,
            first_is_x_to_y,
    ...
    public entry fun withdraw<Y, Z, E2, E3>(
        ...
        let tapt_coins = coin::withdraw<StakedAptos>(sender, amount);
    ...
    public fun unstake<Y, Z, E2, E3>(
        ...
        third_pool_type: u64,
        third_is_x_to_y: bool, // second trade uses normal order
        tapt_coins: Coin<StakedAptos>
    ): (Coin<StakedAptos>, Coin<Y>, Coin<Z>, Coin<AptosCoin>) {
        let (
            tapt_opt,
            y_opt,
            z_opt,
            apt_coins
        ) = aggregator::swap_direct<StakedAptos, Y, Z, AptosCoin, u8, E2, E3>(
            num_steps,
            first_dex_type,
            first_pool_type,
            first_is_x_to_y,
    ...
    public fun unstake_exact_out<Y, Z, E2, E3>(
        ...
        let (
            ...
            tapt_coins,
            apt_coins
        ) = aggregator::swap_exact_out_with_change_direct<StakedAptos, Y, Z, AptosCoin, u8, E2, E3>(
            num_steps,
            first_dex_type,
            first_pool_type,
            first_is_x_to_y,
        ...
        let tapt = utils::merge_coin_and_coin_opt<StakedAptos>(tapt_coins, tapt_opt);
